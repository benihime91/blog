---
keywords: fastai
description: A tutorial to code a neural network from scratch in python using numpy.
...
nb_path: _notebooks/2020-09-22-nn-from-scratch.ipynb
layout: notebook
---
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>{% include youtube.html content='<a href="https://www.youtube.com/watch?v=aircAruvnKk&amp;list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi">https://www.youtube.com/watch?v=aircAruvnKk&amp;list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi</a>' %}</p>
...
<p>{% include note.html content='the above code snippet will download the dataset to <code>{path}</code> so be sure to set the <code>{path}</code> to the desired location of your choice. ' %}</p>
...
{% include youtube.html content='<a href="https://youtu.be/1waHlpKiNyY?t=243">https://youtu.be/1waHlpKiNyY?t=243</a>' %}</p>
...
{% include note.html content='<code>@</code> in python is the <code>matrix-multiplication operator</code>. ' %}</p>
...
<p>{% include note.html content='This is not actual code it&#8217;s just psuedo-code for understanding.' %}</p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>{% include note.html content='<code>z</code>, <code>w</code>, <code>b</code>, <code>a_prev</code> are the outputs, weights, bias and input-activations of the Linear layer respectively.' %}</p>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Accuracy: 0.9970782280867108
</pre>
</div>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Accuracy: 0.997566909975669
</pre>
</div>
</div>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>{% include note.html content='our model achieved a <code>accuracy</code> of <strong><code>0.99</code></strong> on both the <code>train</code> and the <code>validation</code> set !' %}</p>
...
<div class="output_png output_subarea ">
<img src="data:image/png;base64,
"
>
</div>
